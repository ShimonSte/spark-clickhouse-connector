error id: file://<WORKSPACE>/spark-3.4/clickhouse-spark-it/src/test/scala/org/apache/spark/sql/clickhouse/single/ClickHouseDataTypeSuite.scala:`<error>`#`<error>`.
...
non-local guesses:
	 -org/apache/spark/sql/types/runClickHouseSQL.
	 -org/apache/spark/sql/types/runClickHouseSQL#
	 -org/apache/spark/sql/types/runClickHouseSQL().
	 -runClickHouseSQL.
	 -runClickHouseSQL#
	 -runClickHouseSQL().
	 -scala/Predef.runClickHouseSQL.
	 -scala/Predef.runClickHouseSQL#
	 -scala/Predef.runClickHouseSQL().
offset: 4882
