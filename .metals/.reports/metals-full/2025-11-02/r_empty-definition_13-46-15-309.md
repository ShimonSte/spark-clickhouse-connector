error id: file://<WORKSPACE>/spark-3.3/clickhouse-spark/src/main/scala/com/clickhouse/spark/read/format/ClickHouseBinaryReader.scala:
file://<WORKSPACE>/spark-3.3/clickhouse-spark/src/main/scala/com/clickhouse/spark/read/format/ClickHouseBinaryReader.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb

found definition using fallback; symbol StructField
offset: 3997
uri: file://<WORKSPACE>/spark-3.3/clickhouse-spark/src/main/scala/com/clickhouse/spark/read/format/ClickHouseBinaryReader.scala
text:
```scala
/*
