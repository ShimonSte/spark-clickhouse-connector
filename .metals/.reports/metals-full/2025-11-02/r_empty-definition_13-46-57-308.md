error id: file://<WORKSPACE>/spark-3.4/clickhouse-spark-it/src/test/scala/org/apache/spark/sql/clickhouse/single/ClickHouseDataTypeSuite.scala:org/apache/spark/sql/clickhouse/single/`<error: <none>>`.
file://<WORKSPACE>/spark-3.4/clickhouse-spark-it/src/test/scala/org/apache/spark/sql/clickhouse/single/ClickHouseDataTypeSuite.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -org/apache/spark/sql/types/org/apache/spark/sql/types/DataTypes.
	 -org/apache/spark/sql/types/DataTypes.
	 -scala/Predef.org.apache.spark.sql.types.DataTypes.
offset: 858
uri: file://<WORKSPACE>/spark-3.4/clickhouse-spark-it/src/test/scala/org/apache/spark/sql/clickhouse/single/ClickHouseDataTypeSuite.scala
text:
```scala
/*
